...
public class PaymentApplication {
    ...
    public void runPaymentApp() {
        ...
        do {
            ...
            System.out.println("2. Payment 코드로 조회");
            System.out.println("3. Payment 정보 추가");
            System.out.println("4. Payment 정보 수정");
            System.out.println("5. Payment 정보 삭제");
            System.out.println("Payment 정보 관리 번호를 입력해주세요 : ");
            int no = sc.nextInt();

            switch (no) {
                case 1 : paymentController.selectAllPaymentInfo(); break;
//                case 2 : paymentController.selectPaymentByCode
